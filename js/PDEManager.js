...
PDEManager = function(app_id_pde, app_code_pde, layersObjects)
{
	...
	this.indexURL = "http://pde.cit.api.here.com/1/index.json";
	this.staticContentUrl = "http://pde.cit.api.here.com/1/static.json";
	this.region = null;
	this.release = "2013Q4";
...
/**
	Set the PDE region that is used for making PDE requests
*/
...
/**
	Get the PDE region that is used for making PDE requests
*/
...
/**
	Set the (router) map release that is used for making PDE requests
*/
...
/**
	Get the (router) map release that is used for making PDE requests
*/
...
PDEManager.prototype.requestPDETile = function(tile, layer, callback, isFcLayer)
{
	...
	{ 
		...
		var url = this.baseURL + "?" +(this.region != null ? "region=" + this.region + "&" : "")+ "release=" + this.release + "&layer=" + layerName +
					  "&level=" + tile.level + "&tilex=" + tile.tileX + "&tiley=" + tile.tileY + "&app_id=" + this.app_id_pde + "&app_code=" + this.app_code_pde + "&callback=" + callbackName;
...
PDEManager.prototype.requestPDEIndex = function(attribute, layer, values, callback)
{
	...
	{ 
		...
		var url = this.indexURL + "?" +(this.region != null ? "region=" + this.region + "&" : "")+ "release=" + this.release + "&layer=" + layer +
					  "&attributes=" + attribute + "&values=" + values + "&app_id=" + this.app_id_pde + "&app_code=" + this.app_code_pde + "&callback=" + callbackName;
...
PDEManager.prototype.requestPDEStaticContent = function(content, callback)
{
	...
	{ 
		...
		var url = this.staticContentURL + "?" +(this.region != null ? "region=" + this.region + "&" : "")+ "release=" + this.release + "&content=" + content +
					  "&app_id=" + this.app_id_pde + "&app_code=" + this.app_code_pde + "&callback=" + callbackName;
...
PDEManager.prototype.requestPDEFile = function(path, layer, callback)
{
	if (callback && typeof(callback) === "function")
	{
		...
		var url = this.fileURL + "?region=" + this.region + "&release=" + this.release + "&layer=" + layer + 
					  "&path=" + path + "&app_id=" + this.app_id_pde + "&app_code=" + this.app_code_pde + "&callback=" + callbackName;
